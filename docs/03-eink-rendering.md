...
- Deep sleep: the refresh loop freezes (verified from logs); the screensaver appears while asleep — the user wants it never (→ „Wach bleiben“ / Stay Awake user setting; no verified script-level keep-awake mechanism).
